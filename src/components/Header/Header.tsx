    ...
    <header className="header-wrapper">
      <div className="wrapper flex">
        <button
          className={
            isMobileNavActive
              ? "header-mobile-activator active"
        ...
        <nav className={isMobileNavActive ? "flex active" : "flex"}>
          ...
          <Link
            className={isActiveHash(null, "#take-a-tour") ? "active" : ""}
            to="/#take-a-tour"
            onClick={toggleMobileNav}
          >
            Take a Tour
          ...
          <Link
            className={isActiveHash(null, "#how-it-works") ? "active" : ""}
            to="/#how-it-works"
            onClick={toggleMobileNav}
          >
            How it Works
          ...
          <Link
            className={isActiveHash(null, "#faq") ? "active" : ""}
            to="/#faq"
            onClick={toggleMobileNav}
          >
            FAQ
